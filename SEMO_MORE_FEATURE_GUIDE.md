...
- 중앙 코어 크기: 현재 티어에서 바깥 삼각이 성장한 평균 정도
...
이 표시는 클럽의 품질, 인기도, 회원 수, 경쟁 순위를 뜻하지 않습니다. 검색 정렬, 가입 추천 가중치, 기능 잠금 해제, 금전적 보상에도 사용하지 않습니다. 회원 수는 코어 크기나 소재에 섞지 않고 기존 회원 정보로 별도 표시합니다.
