...
소재와 삼각 진행은 클럽의 품질, 인기도, 회원 수, 경쟁 순위를 뜻하지 않습니다. 코어 크기만 활성 멤버 수를 나타내며, 작은 모임도 구분되고 큰 모임이 화면을 압도하지 않도록 `1명`, `2~4명`, `5~9명`, `10~19명`, `20~49명`, `50명 이상`의 6단계 크기를 사용합니다. 정확한 회원 수는 기존 숫자 정보로도 제공합니다. 회원 수는 소재, 세 축 점수, 검색 정렬, 가입 추천 가중치, 기능 잠금 해제, 금전적 보상에 영향을 주지 않습니다.
