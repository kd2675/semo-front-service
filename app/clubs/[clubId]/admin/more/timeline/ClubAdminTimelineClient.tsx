      ...
      <div className="semo-page-admin min-h-screen bg-[var(--background-light)] pb-28">
        ...
        <main className="semo-nav-bottom-space space-y-4 px-4 pt-4">
          ...
          >
            ...
            <h2 className="mt-3 text-2xl font-bold">멤버에게는 본인의 활동만 보여요.</h2>
          ...
          >
            <div className="flex items-start gap-3">
              <span className="material-symbols-outlined mt-0.5 text-[#ec5b13]" aria-hidden="true">info</span>
              <div className="space-y-2 text-sm text-slate-600">
                <p>운영 중인 클럽: {initialData.clubName}</p>
