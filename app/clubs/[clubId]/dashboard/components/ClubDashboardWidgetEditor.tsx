  ...
  return (
    ...
    >
      <button
        ...
        aria-label={`${getWidgetDisplayName(widget)} 순서 변경`}
      ...
      >
        <span className="material-symbols-outlined text-[22px]" aria-hidden="true">{widget.iconName}</span>
      </div>
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          <p className="truncate text-base font-bold text-slate-900">{getWidgetDisplayName(widget)}</p>
  ...
  return (
    <article className="pointer-events-none w-[min(calc(100vw-2rem),72rem)] rounded-2xl border border-[var(--primary)]/30 bg-white px-4 py-4 shadow-[0_20px_44px_rgba(15,23,42,0.18)] ring-2 ring-[var(--primary)]/15">
      <div className="flex min-h-[96px] items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-base font-bold text-slate-900">{getWidgetDisplayName(widget)}</p>
...
export function ClubDashboardWidgetEditor({
  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        <div className="mb-4 flex items-center gap-2">
          <span className="material-symbols-outlined text-[var(--primary)]" aria-hidden="true">add_circle</span>
      ...
      <section>
        <div className="mb-4 flex items-center gap-2">
          <span className="material-symbols-outlined text-slate-500" aria-hidden="true">lock</span>
